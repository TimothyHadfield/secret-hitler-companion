...
_Last updated: 2026-08-01 (session 46: admin account can edit Game theory live — Firestore-backed content, rules-enforced admin write)._
...
## Rules & Game Theory handbook + community notes (session 38; Game theory rebuilt s45, admin-editable s46)
- **🔑 ADMIN-EDITABLE Game theory (session 46).** A single privileged account —
