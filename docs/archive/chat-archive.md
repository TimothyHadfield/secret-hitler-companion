# CHAT archive — Secret Hitler Companion

_Oldest whole entries moved out of `CHAT.md` unchanged (newest archived entry at the bottom). The live log is `CHAT.md`; the current state is `PROGRESS.md`._

<!-- moved 2026-09-21: Session 1 through Session 27 -->
